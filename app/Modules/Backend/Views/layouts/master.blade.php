...
<head>
    ...
    <link rel="apple-touch-icon" href="{{ URL::asset('assets/backend/img/icon57.png') }}" sizes="57x57">
    <link rel="apple-touch-icon" href="{{ URL::asset('assets/backend/img/icon72.png') }}" sizes="72x72">
    <link rel="apple-touch-icon" href="{{ URL::asset('assets/backend/img/icon76.png') }}" sizes="76x76">
    <link rel="apple-touch-icon" href="{{ URL::asset('assets/backend/img/icon114.png') }}" sizes="114x114">
    <link rel="apple-touch-icon" href="{{ URL::asset('assets/backend/img/icon120.png') }}g" sizes="120x120">
    <link rel="apple-touch-icon" href="{{ URL::asset('assets/backend/img/icon144.png') }}" sizes="144x144">
    <link rel="apple-touch-icon" href="{{ URL::asset('assets/backend/img/icon152.png') }}g" sizes="152x152">
    <link rel="apple-touch-icon" href="{{ URL::asset('assets/backend/img/icon180.png') }}" sizes="180x180">
    <!-- END Icons -->

    <!-- Stylesheets -->
    <!-- Bootstrap is included in its original form, unaltered -->
    <link rel="stylesheet" href="{{ URL::asset('assets/backend/css/bootstrap.min.css') }}">

    <!-- Related styles of various icon packs and plugins -->
    <link rel="stylesheet" href="{{ URL::asset('assets/backend/css/plugins.css') }}">

    <!-- The main stylesheet of this template. All Bootstrap overwrites are defined in here -->
    <link rel="stylesheet" href="{{ URL::asset('assets/backend/css/main.css') }}">

    <!-- Include a specific file here from css/themes/ folder to alter the default theme of the template -->

    <!-- The themes stylesheet of this template (for using specific theme color in individual elements - must included last) -->
    <link rel="stylesheet" href="{{ URL::asset('assets/backend/css/themes.css') }}">
    <!-- END Stylesheets -->

    <!-- Modernizr (browser feature detection library) -->
    <script src="{{ URL::asset('assets/backend/js/vendor/modernizr-3.3.1.min.js') }}"></script>
</head>
<body>
<!-- Page Wrapper -->
...
<script src="{{ URL::asset('assets/backend/js/vendor/jquery-2.2.4.min.js') }}"></script>
<script src="{{ URL::asset('assets/backend/js/vendor/bootstrap.min.js') }}"></script>
<script src="{{ URL::asset('assets/backend/js/plugins.js') }}"></script>
